...
//Altered by Mayank Sehgal for use in Skill Project, Feb 2018.
        ...
        var methods = {
            ...
            *******************************/			
            ...
            initializeItems: function() {
                ...
                $.ajax({
                    type: "GET",
                    url: settings.wikiURL + settings.apiPath + "/api.php?action=parse&format=json&prop=text&redirects"+ section +"&page="+ page +"&callback=?",
            ...
            showError: function(){
                object.html('<div class="nbs-wikiblurb-error">There is no description available for this node.</div>');
            }
        };
